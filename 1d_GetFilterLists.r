...
# }
good_depth = depths$INFO >= args$site_min_depth & depths$INFO <= args$site_max_depth
...
# # Fix TASSEL case change
output$Chromosome = sub(tolower(output$Chromosome), pattern="version", repl="Version")
